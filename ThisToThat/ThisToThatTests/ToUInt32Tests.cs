    ...
    public class ToUInt32Tests
    {
        ...
        */
        ...
        public void TestInt64ToUInt32OrDefault()
        {
            ...
            result = source.ToUInt32OrDefault(86u);
            // Here we would expect this conversion to fail (and return the default value of 86u), 
            // since the source type's maximum value (9.22337203685478E+18) is greater than the target type's maximum value (4294967295).
            Assert.AreEqual(86u, result);
            Assert.IsInstanceOfType(result, typeof(UInt32));
        ...
        public void TestUInt64ToUInt32OrDefault()
        {
            ...
            result = source.ToUInt32OrDefault(86u);
            // Here we would expect this conversion to fail (and return the default value of 86u), 
            // since the source type's maximum value (1.84467440737096E+19) is greater than the target type's maximum value (4294967295).
            Assert.AreEqual(86u, result);
            Assert.IsInstanceOfType(result, typeof(UInt32));
        ...
        /// <summary>
        /// Makes multiple Single to UInt32 or default conversions and asserts that the results are correct.
        /// </summary>
        [TestMethod, TestCategory("ToUInt32 tests")]
        public void TestSingleToUInt32OrDefault()
        {
            // Test conversion of source type minimum value
            ...
            result = source.ToUInt32OrDefault(86u);
            // Here we would expect this conversion to fail (and return the default value of 86u), 
            // since the source type's maximum value (3.40282346638529E+38) is greater than the target type's maximum value (4294967295).
            Assert.AreEqual(86u, result);
            Assert.IsInstanceOfType(result, typeof(UInt32));
        ...
        /// <summary>
        /// Makes multiple Single to nullable UInt32 conversions and asserts that the results are correct.
        /// </summary>
        [TestMethod, TestCategory("ToUInt32 tests")]
        public void TestSingleToUInt32Nullable()
        {
            // Test conversion of source type minimum value
            Single source = Single.MinValue;
            Assert.IsInstanceOfType(source, typeof(Single));
        ...
        /// <summary>
        /// Makes multiple Double to UInt32 or default conversions and asserts that the results are correct.
        /// </summary>
        [TestMethod, TestCategory("ToUInt32 tests")]
        public void TestDoubleToUInt32OrDefault()
        {
            // Test conversion of source type minimum value
            ...
            result = source.ToUInt32OrDefault(86u);
            // Here we would expect this conversion to fail (and return the default value of 86u), 
            // since the source type's maximum value (1.79769313486232E+308) is greater than the target type's maximum value (4294967295).
            Assert.AreEqual(86u, result);
            Assert.IsInstanceOfType(result, typeof(UInt32));
        ...
        /// <summary>
        /// Makes multiple Double to nullable UInt32 conversions and asserts that the results are correct.
        /// </summary>
        [TestMethod, TestCategory("ToUInt32 tests")]
        public void TestDoubleToUInt32Nullable()
        {
            // Test conversion of source type minimum value
            Double source = Double.MinValue;
            Assert.IsInstanceOfType(source, typeof(Double));
        ...
        /// <summary>
        /// Makes multiple Decimal to UInt32 or default conversions and asserts that the results are correct.
        /// </summary>
        [TestMethod, TestCategory("ToUInt32 tests")]
        public void TestDecimalToUInt32OrDefault()
        {
            // Test conversion of source type minimum value
            ...
            result = source.ToUInt32OrDefault(86u);
            // Here we would expect this conversion to fail (and return the default value of 86u), 
            // since the source type's maximum value (7.92281625142643E+28) is greater than the target type's maximum value (4294967295).
            Assert.AreEqual(86u, result);
            Assert.IsInstanceOfType(result, typeof(UInt32));
        ...
        /// <summary>
        /// Makes multiple Decimal to nullable UInt32 conversions and asserts that the results are correct.
        /// </summary>
        [TestMethod, TestCategory("ToUInt32 tests")]
        public void TestDecimalToUInt32Nullable()
        {
            // Test conversion of source type minimum value
            Decimal source = Decimal.MinValue;
            Assert.IsInstanceOfType(source, typeof(Decimal));
