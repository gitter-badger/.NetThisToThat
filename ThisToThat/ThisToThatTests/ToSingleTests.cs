    ...
    public class ToSingleTests
    {
        ...
        */
        ...
        public void TestDoubleToSingleOrDefault()
        {
            ...
            // since the source type's minimum value (-1.79769313486232E+308) is less than the target type's minimum value (-3.40282346638529E+38).
            ...
            result = source.ToSingleOrDefault(86f);
            // Here we would expect this conversion to fail (and return the default value of 86f), 
            // since the source type's maximum value (1.79769313486232E+308) is greater than the target type's maximum value (3.40282346638529E+38).
            Assert.AreEqual(86f, result);
            Assert.IsInstanceOfType(result, typeof(Single));
